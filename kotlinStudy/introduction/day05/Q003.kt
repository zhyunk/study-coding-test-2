...
class Solution53 {
    fun solution(a: Int, b: Int, c: Int): Int {
        val sets = intArrayOf(a,b,c).toSet()
    ...
    /*
   fun solution(a: Int, b: Int, c: Int): Int {
        return if (a == b && b == c) (a+b+c)*(a*a+b*b+c*c)*(a*a*a+b*b*b+c*c*c)
            else if (a == b || b == c || a == c) (a+b+c)*(a*a+b*b+c*c)
            else (a+b+c)
    }
*/
...
fun main() {
    println(Solution53().solution(4,4,4))
}
