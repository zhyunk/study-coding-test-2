package kotlinStudy.introduction.day16

/**
https://school.programmers.co.kr/learn/courses/30/lessons/181875?language=kotlin
 *문제 설명
...
class Solution3 {
    fun solution(strArr: Array<String>): Array<String> {
        return strArr.mapIndexed { index, s -> if (index % 2 == 0) s.lowercase() else s.uppercase() }.toTypedArray()
    }

}

fun main() {
    println(Solution3().solution(arrayOf("AAA","BBB","CCC","DDD")).joinToString(", "))
    println(Solution3().solution(arrayOf("aBc","AbC")).joinToString(", "))
}
