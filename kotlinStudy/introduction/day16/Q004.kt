...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181874?language=kotlin
 *문제 설명
 * 문자열 myString이 주어집니다.
...
class Solution4 {
    ...
    /*
    fun solution(myString: String): String {
        return myString.lowercase().map { if (it == 'a') 'A' else it }.joinToString("")
    }
*/
}

fun main() {
    println(Solution4().solution("abstract algebra"))
    println(Solution4().solution("PrOgRaMmErS"))
}
