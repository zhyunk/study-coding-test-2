...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181914?language=kotlin
 *문제 설명
...
class Solution84 {
    ...
    */
    ...
    /*
    fun solution(number: String): Int {
        return number.split("").filter { it.isNotEmpty() }.sumOf { it.toInt() } % 9
    }
    */
}

fun main() {
    println(Solution84().solution("78720646226947352489"))
}
