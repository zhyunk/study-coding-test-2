...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181915?language=kotlin
 *문제 설명
 ...
 * 입출력 예 설명
     * 입출력 예 #1
        ...
        * my_string에서 index_list에 들어있는 원소에 해당하는 인덱스의 글자들은 각각 순서대로 p, r, o, g, r, a, m, m, e, r, s입니다.
...
class Solution83 {
    ...
    */
    ...
    /*
    fun solution(my_string: String, index_list: IntArray): String {
        return index_list.fold("") { acc, i -> acc + my_string[i] }
    }
    */
}

fun main() {
    println(Solution83().solution("cvsgiorszzzmrpaqpe", intArrayOf(16, 6, 5, 3, 12, 14, 11, 11, 17, 12, 7)))
}
