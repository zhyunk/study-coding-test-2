...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181841?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution232().solution(arrayOf("abc", "def", "ghi"), "ef"))
    println(Solution232().solution(arrayOf("abc", "bbc", "cbc"), "c"))
}
