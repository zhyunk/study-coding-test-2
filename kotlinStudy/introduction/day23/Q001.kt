...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181842?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution231().solution("abc", "aabcc"))
    println(Solution231().solution("tbt", "tbbttb"))
}
