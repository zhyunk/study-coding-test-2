...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181906?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution102().solution("banana",	"ban"))
    println(Solution102().solution("banana",	"nan"))
    println(Solution102().solution("banana",	"abcd"))
    println(Solution102().solution("banana",	"bananan"))
}
