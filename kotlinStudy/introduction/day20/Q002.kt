...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181856?language=kotlin
 *문제 설명
...
class Solution202 {
    fun solution(arr1: IntArray, arr2: IntArray): Int {
        val a2size = arr2.size
        val a1size = arr1.size
        val a2sum = arr2.sum()
        val a1sum = arr1.sum()
    ...
    fun solution(arr1: IntArray, arr2: IntArray): Int {
        ...
        return if (a2size == a1size) {
            if (a2sum > a1sum) -1
            else if (a2sum < a1sum) 1
            else 0
        } else if (a2size > a1size) -1
        else 1
    }
    */
}
...
fun main() {
    println(Solution202().solution(intArrayOf(49, 13), intArrayOf(70, 11, 2)))
    println(Solution202().solution(intArrayOf(100, 17, 84, 1), intArrayOf(55, 12, 65, 36)))
    println(Solution202().solution(intArrayOf(1, 2, 3, 4, 5), intArrayOf(3, 3, 3, 3, 3)))
}
