...
class Solution224 {
    fun solution(arr: IntArray, delete_list: IntArray): IntArray {
        return (arr.toList() - delete_list.toSet()).toIntArray()
    }

    /*
    fun solution(arr: IntArray, delete_list: IntArray): IntArray {
        return arr.filterNot { delete_list.contains(it) }.toIntArray()
    }
*/
}

fun main() {
    println(Solution224().solution(intArrayOf(293, 1000, 395, 678, 94), intArrayOf(94, 777, 104, 1000, 1, 12)).joinToString(", "))
    println(Solution224().solution(intArrayOf(110, 66, 439, 785, 1), intArrayOf(377, 823, 119, 43)).joinToString(", "))
}
