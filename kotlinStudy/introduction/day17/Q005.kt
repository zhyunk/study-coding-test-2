...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181868?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution5().solution(" i    love  you").joinToString(", "))
    println(Solution5().solution("    programmers  ").joinToString(", "))
}
