...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181869?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution174().solution("i love you").joinToString(", "))
    println(Solution174().solution("programmers").joinToString(", "))
}
