...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181872?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution171().solution("AbCdEFG", "dE"))
    println(Solution171().solution("AAAAaaaa", "a"))
}
