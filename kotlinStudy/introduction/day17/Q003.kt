...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181870?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution173().solution(arrayOf("and","notad","abcd")).joinToString(", "))
    println(Solution173().solution(arrayOf("there","are","no","a","ds")).joinToString(", "))
}
