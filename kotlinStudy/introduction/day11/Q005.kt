...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181898?language=kotlin
 *문제 설명
 * 정수 배열 arr가 주어집니다.
...
class Solution115 {
    fun solution(arr: IntArray, idx: Int): Int {
        return (idx until arr.size).firstOrNull { arr[it] == 1 } ?: -1
    }
...
fun main() {
    println(Solution115().solution(intArrayOf(1, 0, 0, 1, 0, 0), 4))
}
