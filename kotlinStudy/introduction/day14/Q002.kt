...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181886?language=kotlin
 *문제 설명
...
class Solution142 {
    ...
    */
    ...
    /*
    fun solution(names: Array<String>): Array<String> {
        return (names.indices step 5).map { names[it] }.toList().toTypedArray()
    }
    */
}

fun main() {
    println(Solution142().solution(arrayOf("nami", "ahri", "jayce", "garen", "ivern", "vex", "jinx")).joinToString(", "))
}
