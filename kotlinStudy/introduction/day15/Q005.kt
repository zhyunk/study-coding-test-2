...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181878?language=kotlin
 *문제 설명
...
class Solution155 {
    ...
    /*
    fun solution(myString: String, pat: String): Int {
        return myString.lowercase().contains(pat.lowercase()).compareTo(false)
    }
    */
}

fun main() {
    println(Solution155().solution("AbCdEfG", "aBc"))
    println(Solution155().solution("aaAA", "aaaaa"))
}
