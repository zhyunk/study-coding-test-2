...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181867?language=kotlin
 *문제 설명
 * 문자열 myString이 주어집니다.
...
fun main() {
    println(Solution181().solution("oxooxoxxox").joinToString(", "))
    println(Solution181().solution("xabcxdefxghi").joinToString(", "))
}
