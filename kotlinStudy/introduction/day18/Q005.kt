...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181863?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution185().solution("masterpiece"))
    println(Solution185().solution("programmers"))
    println(Solution185().solution("jerry"))
    println(Solution185().solution("burn"))
}
