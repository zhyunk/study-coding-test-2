...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181837?language=kotlin
 *문제 설명
...
class Solution241 {
    ...
    /*
    fun solution(order: Array<String>): Int {
        return order.fold(0) { acc, s -> if (s.contains("cafelatte")) acc + 5000 else acc + 4500 }
    }
    */
}

fun main() {
    println(Solution241().solution(arrayOf("cafelatte", "americanoice", "hotcafelatte", "anything")))
    println(Solution241().solution(arrayOf("americanoice", "americano", "iceamericano")))
}
