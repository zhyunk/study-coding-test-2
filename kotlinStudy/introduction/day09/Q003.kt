...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181910?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution93().solution("ProgrammerS123", 11))
    println(Solution93().solution("He110W0r1d", 5))
}
