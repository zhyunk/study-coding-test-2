...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181861?language=kotlin
 *문제 설명
...
class Solution192 {
    ...
    /*
    fun solution(arr: IntArray): IntArray {
        return arr.joinToString { ",$it".repeat(it) }
            .split(Regex("[ ,]"))
...
fun main() {
    println(Solution192().solution(intArrayOf(5, 1, 4)).joinToString(", "))
    println(Solution192().solution(intArrayOf(6, 6)).joinToString(", "))
    println(Solution192().solution(intArrayOf(6, 33, 4)).joinToString(", "))
    println(Solution192().solution(intArrayOf(1)).joinToString(", "))
}
