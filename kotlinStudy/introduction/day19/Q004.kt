...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181859?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution194().solution(intArrayOf(0, 1, 1, 1, 0)).joinToString(", "))
    println(Solution194().solution(intArrayOf(0, 1, 0, 1, 0)).joinToString(", "))
    println(Solution194().solution(intArrayOf(0, 1, 1, 0)).joinToString(", "))
}
