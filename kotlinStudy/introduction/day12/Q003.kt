...
class Solution123 {
    fun solution(arr: IntArray, intervals: Array<IntArray>): IntArray {
        return intervals.flatMap { arr.sliceArray(IntRange(it[0], it[1])).toList() }.toIntArray()
    }
...
fun main() {
    println(Solution123().solution(intArrayOf(1, 2, 3, 4, 5), arrayOf(intArrayOf(1, 3),intArrayOf(0, 4))).joinToString(", "))
}
