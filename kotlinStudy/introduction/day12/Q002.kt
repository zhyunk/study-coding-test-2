...
/**
https://school.programmers.co.kr/learn/courses/30/lessons/181896?language=kotlin
 *문제 설명
...
fun main() {
    println(Solution122().solution(intArrayOf(12, 4, 15, 46, 38, -2, 15)))
    println(Solution122().solution(intArrayOf(13, 22, 53, 24, 15, 6)))
}
